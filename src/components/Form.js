...
export default function Form(props) {
  ...
  const handleSelection1Change = (event) => {
    ...
    if (selectedOption1) {
      if (
        vehiclemax.get(selectedOption1.slice(0, -1)) <
        planetdis[event.target.value]
      ) {
        alert(
          "vehicle distance must be more or equal to planet, secnario reset "
        );
        window.location.reload();
      }
      time[1] =
        planetdis[event.target.value] /
        vehicledist.get(selectedOption1.slice(0, -1));
    }
  };
  ...
  const handleSelection2Change = (event) => {
    ...
    if (selectedOption2) {
      if (
        vehiclemax.get(selectedOption2.slice(0, -1)) <
        planetdis[event.target.value]
      ) {
        alert(
          "vehicle distance must be more or equal to planet, secnario reset "
      ...
      time[2] =
        planetdis[event.target.value] /
        vehicledist.get(selectedOption2.slice(0, -1));
    }
  };
  ...
  const handleSelection3Change = (event) => {
    ...
    if (selectedOption3) {
      if (
        vehiclemax.get(selectedOption3.slice(0, -1)) <
        planetdis[event.target.value]
      ) {
        alert(
          "vehicle distance must be more or equal to planet, secnario reset "
      ...
      time[3] =
        planetdis[event.target.value] /
        vehicledist.get(selectedOption3.slice(0, -1));
    }
  };
  ...
  const handleSelection4Change = (event) => {
    ...
    if (selectedOption4) {
      if (
        vehiclemax.get(selectedOption4.slice(0, -1)) <
        planetdis[event.target.value]
      ) {
        alert(
          "vehicle distance must be more or equal to planet, secnario reset "
  ...
  const sendPostRequest = async () => {
    let finalData = {
      ...
      vehicle_names: [
        selectedOption1.slice(0, -1),
        selectedOption2.slice(0, -1),
        selectedOption3.slice(0, -1),
        selectedOption4.slice(0, -1),
      ],
    };
